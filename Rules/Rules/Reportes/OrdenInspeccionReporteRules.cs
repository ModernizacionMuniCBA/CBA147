...
{
    public class OrdenInspeccionReporteRules
    {
        ...
        public OrdenInspeccionReporteRules(UsuarioLogueado data)
        {
            this.data = data;
        }
        ...
        public Result<Telerik.Reporting.Report> GenerarReporteListadoOrdenes(List<int> ids, string filtros)
        {
            ...
            try
            {
                ...
                var resultData = OrdenInspeccionDAO.Instance.GetResultadoTablaByIds(int.MaxValue, ids);
                ...
                var rutaReporte = HttpContext.Current.Server.MapPath("~/Resources/Reportes/OrdenInspeccion/Reporte_OrdenTrabajoListado.trdx");
        ...
        public Result<Telerik.Reporting.Report> GenerarReporteOrdenInspeccionListadoRequerimientos(Resultado_OrdenInspeccionDetalle orden)
        {
            ...
            try
            {
                var rutaReporte = HttpContext.Current.Server.MapPath("~/Resources/Reportes/OrdenInspeccion/ResumenOT/Reporte_OrdenEncabezado.trdx");
                ...
                if (orden.Barrios != null && orden.Barrios.Count > 0 )
                {
        ...
        public Result<Telerik.Reporting.Report> crearSubreporte(Resultado_OrdenInspeccionDetalle orden)
        {
            var result = new Result<Telerik.Reporting.Report>();

            try
            {
                var rutaReporte = HttpContext.Current.Server.MapPath("~/Resources/Reportes/OrdenInspeccion/ResumenOT/Reporte_OrdenDetalleListadoRequerimientos.trdx");
                Telerik.Reporting.Report reporte = new Telerik.Reporting.Report();
                System.Xml.XmlReaderSettings settings = new System.Xml.XmlReaderSettings();
        ...
        public Result<Telerik.Reporting.ReportBook> GenerarReporteOrdenInspeccionDetallado(Resultado_OrdenInspeccionDetalle orden, bool conMapa)
        {
            ...
            try
            {
                ...
                var resultadoReporteEncabezado = GenerarReporteOrdenInspeccionListadoRequerimientos(orden);
