<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="EdificioMunicipalConsulta.aspx.cs" Inherits="UI.EdificioMunicipalConsulta" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
                ...
                <div class="row">                  
                    ...
                    <div class="col s12 m4">
                        <div class="mi-input-field">
                            ...
                            <select id="selectFormulario_Categoria" style="width: 100%"></select>
                        </div>
                    </div>
    ...
    <!-- Mi JS -->
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/EdificioMunicipalConsulta.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
