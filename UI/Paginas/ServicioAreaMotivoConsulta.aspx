...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div id="panel">
        <div class="card">
            ...
            <div id="contenedor_Categorias" class="panel">
                <div class="contenedor_Nombre">
                    <label>Categorías</label>
                </div>
                <div class="contenedor_Busqueda">
                    <input type="text" placeholder="buscar" id="input_BuscarCategorias" />
                    <i class="material-icons">search</i>
                </div>
                <div class="contenedor_Items"></div>
                <div class="contenedor_Botones">
                    <a id="btn_ConfigurarCategorias" class="btn-flat waves-effect"><i class="material-icons btn-icono">add</i>Configurar categorias</a>
                </div>
            </div>
            ...
            <div id="contenedor_Motivos" class="panel">
                <div class="contenedor_Nombre">
                    ...
                    <a id="btn_MotivosGenerales" class="waves-effect boton-filtro">Generales</a>
                    <a id="btn_MotivosInternos" class="waves-effect boton-filtro">Internos</a>
                    <a id="btn_MotivosPrivados" class="waves-effect boton-filtro">Privados</a>
                </div>
                <div class="contenedor_Busqueda">
