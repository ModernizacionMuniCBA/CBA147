<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="OrigenPorAmbitoConsulta.aspx.cs" Inherits="UI.OrigenPorAmbitoConsulta" ClientIDMode="Static" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="<%=ResolveUrl("~/Paginas/Styles/OrigenPorAmbitoConsulta.css?v=" + ConfigurationManager.AppSettings["VERSION"]) %>" rel="stylesheet" />
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <!-- Mi JS -->
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/OrigenPorAmbitoConsulta.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
