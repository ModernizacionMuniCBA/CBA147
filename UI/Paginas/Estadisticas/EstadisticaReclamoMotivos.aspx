<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="EstadisticaReclamoMotivos.aspx.cs" Inherits="UI.EstadisticaReclamoMotivos" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
                ...
                <div class="row" style="width: 100%">
                    <div id="contenedor_Acciones">
                        ...
                        <div class="contenido visible">
                            <div>
                                La presente estadística muestra la cantidad de requerimientos en cada Motivo del area seleccionada. Considera los requerimientos creados en el período y en los estados indicados en el filtro. Por ejemplo si selecciona Enero de 2018 y el estado En proceso, se veran los requerimientos que estuvieron en dicho estado en esa fecha, pudiendo actualmente estar en otro estado.
                            </div>
    ...
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/Estadisticas/EstadisticaReclamoMotivos.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
