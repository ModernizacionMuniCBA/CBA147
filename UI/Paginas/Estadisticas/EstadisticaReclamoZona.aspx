<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="EstadisticaReclamoArea.aspx.cs" Inherits="UI.EstadisticaReclamoZona" ClientIDMode="Static" %>

<%@ Register Src="~/Controls/ControlSelectorRangoFecha.ascx" TagName="SelectorFecha" TagPrefix="Controles" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="<%=ResolveUrl("~/Paginas/Styles/EstadisticaReclamoZona.css?v=" + ConfigurationManager.AppSettings["VERSION"]) %>" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
            ...
            <div class="contenedor-main">
                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                     ...
                     <!-- Categoria -->
                     <div class="col s12 m6 l3" id="contenedorSelectCategoria">
                        <div class="mi-input-field">
                            <label class="no-select">Categoria</label>
                            <select id="select_Categoria" style="width: 100%"></select>
                            <a id="errorFormulario_Categoria" class="control-observacion colorTextoError no-select"></a>
                        </div>
                    </div>
                ...
                <div class="row" style="width: 100%">
                    <div id="contenedor_Acciones">
                        ...
                        <div class="contenido visible">
                            <div>
                                La presente estadística muestra la cantidad de requerimientos creados en las zonas del area. Considera los requerimientos creados en el período y en los estados indicados en el filtro.
                            </div>
    ...
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/Estadisticas/EstadisticaReclamoZona.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
