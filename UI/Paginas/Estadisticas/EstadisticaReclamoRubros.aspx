<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="EstadisticaReclamoRubros.aspx.cs" Inherits="UI.EstadisticaReclamoRubros" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
                ...
                <div class="row" style="width: 100%">
                    <div id="contenedor_Acciones">
                        ...
                        <div class="contenido visible">
                            <div>
                                La presente estadística muestra la cantidad de requerimientos en cada Rubro del grupo seleccionada. Considera los requerimientos creados en el período indicado en el filtro.
                            </div>
    ...
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/Estadisticas/EstadisticaReclamoRubros.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
