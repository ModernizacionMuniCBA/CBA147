<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="EstadisticaReclamoOrigen.aspx.cs" Inherits="UI.EstadisticaReclamoOrigen" ClientIDMode="Static" %>

<%@ Register Src="~/Controls/ControlSelectorRangoFecha.ascx" TagName="SelectorFecha" TagPrefix="Controles" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="<%=ResolveUrl("~/Paginas/Styles/EstadisticaReclamoOrigen.css?v=" + ConfigurationManager.AppSettings["VERSION"]) %>" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
                ...
                <div class="row" style="width: 100%">
                    <div id="contenedor_Acciones">
                        ...
                        <div class="contenido visible">
                            <div>
                                Informe estadístico que identifica los requerimientos según los puntos de acceso de carga.
                                Considera los requerimientos creados en el período especificado en el filtro y tiene en cuenta todos los estados.(Nuevo, En proceso, Cancelado, Cerrado, Pendiente, Inspeccion , Completado).
                            </div>
    ...
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/Estadisticas/EstadisticaReclamoOrigen.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
