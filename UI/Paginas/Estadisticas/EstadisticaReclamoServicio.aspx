<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="EstadisticaReclamoServicio.aspx.cs" Inherits="UI.EstadisticaReclamoServicio" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
                ...
                <div class="row" style="width: 100%">
                    <div id="contenedor_Acciones">
                        ...
                        <div class="contenido visible">
                            <div>
                                La presente estadística muestra la cantidad de requerimientos en cada Servicio creados en el rango de fechas ingresado en el filtro. Tiene en cuenta todos los estados (Nuevo, En proceso, Cancelado, Cerrado, Pendiente, Inspeccion , Completado).
                            </div>
    ...
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/Estadisticas/EstadisticaReclamoServicio.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
