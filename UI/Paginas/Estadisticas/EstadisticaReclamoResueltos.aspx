<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="EstadisticaReclamoResueltos.aspx.cs" Inherits="UI.EstadisticaReclamoResueltos" ClientIDMode="Static" %>

<%@ Register Src="~/Controls/ControlSelectorRangoFecha.ascx" TagName="SelectorFecha" TagPrefix="Controles" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="<%=ResolveUrl("~/Paginas/Styles/EstadisticaReclamoResueltos.css?v=" + ConfigurationManager.AppSettings["VERSION"]) %>" rel="stylesheet" />
</asp:Content>
                ...
                <div class="row" style="width: 100%">
                    <div id="contenedor_Acciones">
                        ...
                        <div class="contenido visible">
                            <div>
                                Los datos corresponden a la información del las areas de su incumbencia.
Informe estadístico que muestra las cantidades de los requerimientos resueltos en el período especificado en el filtro. Los mismos se desglosan por mes, de acuerdo a su fecha de creación. Tiene en cuenta los requerimientos en estado final Completado y Cancelado.
Ejemplo: Existen 10 reclamos completados en el mes de Noviembre, de los cuales 5 se crearon en el mismo, 3 en Octubre y 2 en Septiembre.
                            </div>
    ...
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/Estadisticas/EstadisticaReclamoResueltos.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
