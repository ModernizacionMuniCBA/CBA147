<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="EstadisticaReclamoSubArea.aspx.cs" Inherits="UI.EstadisticaReclamoSubArea" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/Estadisticas/EstadisticaReclamoSubArea.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
