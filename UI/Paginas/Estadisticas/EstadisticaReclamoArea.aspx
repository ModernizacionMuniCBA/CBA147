<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="EstadisticaReclamoArea.aspx.cs" Inherits="UI.Paginas.Estadisticas.EstadisticaReclamoArea" ClientIDMode="Static" %>

<%@ Register Src="~/Controls/ControlSelectorRangoFecha.ascx" TagName="SelectorFecha" TagPrefix="Controles" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="<%=ResolveUrl("~/Paginas/Styles/EstadisticaReclamoArea.css?v=" + ConfigurationManager.AppSettings["VERSION"]) %>" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                        <div class="mi-input-field">
                            ...
                            <a id="errorFormulario_" class="control-observacion colorTextoError no-select"></a>
                        </div>
                    </div>    
                </div>
                ...
                <div class="row" style="width: 100%">
                    <div id="contenedor_Acciones">
                        ...
                        <div class="contenido visible">
                            <div>
                                La presente estadística muestra la cantidad de requerimientos creados en mis áreas , respecto a las demás áreas de la municipalidad. Considera los requerimientos creados en el período y en los estados indicados en el filtro.
                            </div>
    ...
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/Estadisticas/EstadisticaReclamoArea.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
