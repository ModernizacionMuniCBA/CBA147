<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="ServicioConsulta.aspx.cs" Inherits="UI.ServicioConsulta" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l6">
                        <div class="input-field">
                            ...
                            <label for="inputBusqueda" class="no-select">Servicio</label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Mi JS -->
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/ServicioConsulta.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
