<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="OrigenPorUsuarioConsulta.aspx.cs" Inherits="UI.OrigenPorUsuarioConsulta" ClientIDMode="Static" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="<%=ResolveUrl("~/Paginas/Styles/OrigenPorUsuarioConsulta.css?v=" + ConfigurationManager.AppSettings["VERSION"]) %>" rel="stylesheet" />
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <!-- Mi JS -->
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/OrigenPorUsuarioConsulta.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
