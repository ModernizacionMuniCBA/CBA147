<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Paginas/_MasterPage.Master" CodeBehind="OrdenTrabajoConsulta.aspx.cs" Inherits="UI.OrdenTrabajoConsulta" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="flex direction-vertical no-scroll ">
        ...
        <div id="cardConsulta" class="card contenedor flex-main flex direction-vertical no-scroll">
            ...
            <div class="contenedor-main">
                            ...
                            <div class="row">
                                <div class="col s8 m6 l4">
                                    <div class="input-field fix-margin">
                                        <input id="input_NroOrdenTrabajo" type="text" />
                                        <label for="input_NroOrdenTrabajo" class="no-select">Número</label>
                ...
                <!-- Area -->
                <div id="contenedor_Area" style="display:none">
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m9 l9">
                            <div class="row">
                                ...
                                <div id="contenedor-selectoresZonaSeccion" style="display: none">
                                    <div class="col s8 m6 l4">
                                        <div class="flex-main mi-input-field">
                                    ...
                                    <div class="col s8 m6 l4">
                                        <div class="flex-main mi-input-field">
                                            ...
                                            <a id="error_Seccion" class="control-observacion colorTextoError no-select" style="display: none"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Mi JS -->
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/OrdenTrabajoConsulta2.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
