<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="AreaConsulta.aspx.cs" Inherits="UI.AreaConsulta" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="flex direction-vertical no-scroll full-height">
            ...
            <div id="alertaOk" class="container" style="display: none;">
                <div class="contenedor-alerta card">
                    ...
                    <div class="contenedor-botones">
                        <a class="btn waves-effect waves-light no-select" id="btnImprimirRequerimiento">Imprimir</a>
                        <a class="btn waves-effect waves-light no-select colorExito" id="btnNuevoRequerimiento">Nuevo</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l6">
                        <div class="input-field">
                            ...
                            <label for="inputBusqueda" class="no-select">Area</label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Grd -->
        <div id="contenedorResultadoConsulta" class="flex-main no-scroll flex direction-vertical full-height">

            <div id="cardResultadoConsulta" class="card contenedor flex direction-vertical full-height">
    ...
    <!-- Mi JS -->
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/AreaConsulta.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
