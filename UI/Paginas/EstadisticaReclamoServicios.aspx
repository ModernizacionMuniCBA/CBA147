<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="EstadisticaReclamoServicios.aspx.cs" Inherits="UI.EstadisticaReclamoServicios" ClientIDMode="Static" %>

<%@ Register Src="~/Controls/ControlSelectorRangoFecha.ascx" TagName="SelectorFecha" TagPrefix="Controles" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="<%=ResolveUrl("~/Paginas/Styles/EstadisticaReclamoServicios.css?v=" + ConfigurationManager.AppSettings["VERSION"]) %>" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="flex direction-vertical full-height">
        ...
        <div id="cardEstadisticas" class="card contenedor flex-main flex full-height" style="display: none">
                ...
                <div class="row" style="width: 100%">
                    <div id="contenedor_Acciones">
                        ...
                        <div class="contenido visible">
                            <div>
                                Informe estadístico que muestra las cantidades de los requerimientos resueltos en el periodo especificado, que se organiza por la fecha de creación  ordenado por mes. Tiene en cuenta los requerimientos en estado final Completado y Cancelado.
                            </div>
                ...
                <div class="mi-input-field">
                    <div class="radio-buttons" style="justify-content: center;">
                        ...
                        <div>
                            ...
                            <label for="radio_Torta">Grafico Circular</label>
                        </div>
                        <div>
            ...
            <div class="contenedor-footer separador">
                <div class="contenedor-botones no-select">
                    <a id="btnVolver" class="btn waves-effect no-select colorExito">Cambiar filtros</a>
    ...
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/EstadisticaReclamoServicios.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
