<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="PermisoEstadoOrdenInspeccion.aspx.cs" Inherits="UI.PermisoEstadoOrdenInspeccion" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <!-- Mi Js -->
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/PermisoEstadoOrdenInspeccion.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
