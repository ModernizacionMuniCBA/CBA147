<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="Administracion.aspx.cs" Inherits="UI.Administracion" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div id="contenedor_General">
        ...
        <div class="contenedor-botones-paginas">
            ...
            <div class="btn-pagina card" id="btnConfiguracionBandejaPorArea">
                <i class="material-icons">build</i>
                <label>Configuracion Bandeja</label>
            </div>
        </div>
    </div>
