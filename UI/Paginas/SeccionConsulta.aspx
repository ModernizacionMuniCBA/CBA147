<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="SeccionConsulta.aspx.cs" Inherits="UI.SeccionConsulta" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
                ...
                <div class="row">                  
                    ...
                    <div class="col s12 m4">
                        <div class="input-field">
                            ...
                            <label for="inputBusqueda" class="no-select">Sección</label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Mi JS -->
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/SeccionConsulta.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
