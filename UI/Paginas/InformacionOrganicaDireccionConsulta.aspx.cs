...
namespace UI
{
    public partial class InformacionOrganicaDireccionConsulta : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var resultadoConsulta = new InformacionOrganicaDireccionRules(usuarioLogeado).GetAll(null);
            ...
            dictionary.Add("Direcciones", Resultado_InformacionOrganicaDireccion.ToList(resultadoConsulta.Return));
