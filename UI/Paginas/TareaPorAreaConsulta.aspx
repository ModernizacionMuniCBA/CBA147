<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="TareaPorAreaConsulta.aspx.cs" Inherits="UI.TareaPorAreaConsulta" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
                ...
                <%--    <div id="contenedorEstado" runat="server" class="col s12 m4">
                    ...
                    <div class="col s12 m4">
                        <div class="input-field">
                            ...
                            <label for="inputBusqueda" class="no-select">Tarea</label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Mi JS -->
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/TareaPorAreaConsulta.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
