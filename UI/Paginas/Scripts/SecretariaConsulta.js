...
function init(data) {
    ...
    cargarResultadoConsulta(secretarias);
...
function filtrarBusqueda() {
    ...
    $.each(secretarias, function (index, secretaria) {

        if (secretaria.Nombre.toUpperCase().indexOf(texto) != -1) {

            switch (estado) {
                case 1:

                    resultados.push(secretaria);
                    break;

                case 2:
                    if (secretaria.FechaBaja == null) {
                        resultados.push(secretaria);
                    }
                    break;
