function init(data) {
    ...
    $('#btnServicioAreaMotivo').css('display', validarPermisoConsulta('ServicioAreaMotivo') ? 'auto' : 'none');
    ...
    $('#btnConfiguracionBandejaPorArea').css('display', validarPermisoConsulta('ConfiguracionBandejaPorArea') ? 'auto' : 'none');
    $('#btnConfiguracionBandejaPorArea').click(function () {
        redirigir('ConfiguracionBandejaPorArea');
    });
