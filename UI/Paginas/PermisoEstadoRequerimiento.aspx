<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/_MasterPage.Master" AutoEventWireup="true" CodeBehind="PermisoEstadoRequerimiento.aspx.cs" Inherits="UI.PermisoEstadoRequerimiento" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <!-- Mi Js -->
    <script type="text/javascript" src="<%=ResolveUrl("~/Paginas/Scripts/PermisoEstadoRequerimiento.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
