<%@ Page Title="" Language="C#" MasterPageFile="~/IFrame/_MasterPageIFrame.Master" AutoEventWireup="true" CodeBehind="IEmpleadoCambiarEstado.aspx.cs" Inherits="UI.IFrame.IEmpleadoCambiarEstado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <!-- Mi JS -->
    <script type="text/javascript" src="<%=ResolveUrl("~/IFrame/Scripts/IEmpleadoCambiarEstado.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
