...
function cambiarEstado() {
    ...
    crearAjax({
        Url: ResolveUrl('~/Servicios/EmpleadoService.asmx/CambiarEstado'),
        Data: { comando: { IdEmpleado: idEmpleado, EstadoKeyValue: keyValue, Observaciones: $('#input_Motivo').val().trim() } },
...
function validar() {
    ...
    if (idEmpleado == undefined || idEmpleado <= 0) {
        mostrarMensajeAlerta('Móvil invalido');
        return false;
    }
