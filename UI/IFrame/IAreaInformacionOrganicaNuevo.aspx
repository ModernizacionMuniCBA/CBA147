<%@ Page Title="" Language="C#" MasterPageFile="~/IFrame/MasterPageIFrame.Master" AutoEventWireup="true" CodeBehind="IAreaInformacionOrganicaNuevo.aspx.cs" Inherits="UI.IFrame.IAreaInformacionOrganicaNuevo" ClientIDMode="Static" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link type="text/css" rel="stylesheet" href="<%=ResolveUrl("~/IFrame/Styles/IAreaInformacionOrganicaNuevo.css?v=" + ConfigurationManager.AppSettings["VERSION"]) %>" media="screen,projection" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <!-- Mi JS -->
    <script type="text/javascript" src="<%=ResolveUrl("~/IFrame/Scripts/IAreaInformacionOrganicaNuevo.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
</asp:Content>
