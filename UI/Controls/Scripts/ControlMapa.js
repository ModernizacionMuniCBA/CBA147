        ...
        getGeoApiInfo()
            .then(function (data) {
                ...
                if (valores.Sugerencia) {
                    ControlMapa_CargarSugerencias(valores.Sugerencia);
                    $($('#ControlMapa_ContenedorSugerencias .sugerencia')[0]).trigger('click');
                    mostrarMensaje("Info","Seleccione la ubicación aproximada dentro del barrio o cpc que ha elegido.")
                }
