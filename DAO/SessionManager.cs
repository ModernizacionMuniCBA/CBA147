...
namespace DAO
{
    public class SessionManager
    {
        ...
        private void Init()
        {
            ...
            //var map = AutoMap.Assembly(baseType.Assembly).Where(t =>
            //    t.Namespace != null &&
            //    t.Namespace.Contains("Model.Entities") && t.IsSubclassOf(baseType));
        ...
        {
            //fmc.Mappings(m => m.FluentMappings.Add<ArchivoPorRequerimientoMap>());
        ...
        private Result<object> EndTransaction(bool yoInicie, bool ok)
        {
