<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ControlMapa.ascx.cs" Inherits="Internet_UI.Controles.ControlMapa" %>
<link type="text/css" rel="stylesheet" href="<%=ResolveUrl("~/Controles/Styles/ControlMapa.css?v=" + ConfigurationManager.AppSettings["VERSION"]) %>" media="screen,projection" />
...
<div id="ControlMapa_Contenedor">
    ...
    <div id="ControlMapa_Botones">
        ...
        <a id="ControlMapa_BtnBarrios" class="btn-mapa">Barrios</a>
        <a id="ControlMapa_BtnEjido" class="btn-mapa">Ejido</a>
    </div>
...
<!-- Mi JS -->
<script type="text/javascript" src="<%=ResolveUrl("~/Controles/Scripts/ControlMapa.js?v=" + ConfigurationManager.AppSettings["VERSION"]) %>"></script>
