...
namespace Model.Resultados
{
    ...
    public class Resultado_OrdenTrabajoInit
    {
        ...
        public List<Resultado_EstadoRequerimiento> EstadosRequerimiento { get; set; }
        public List<Resultado_EstadoOrdenTrabajo> EstadosOrdenTrabajo 
        { get; set; }
        public Resultado_EstadoOrdenTrabajo EstadoOrdenTrabajoPorDefecto { get; set; }
        public List<Resultado_Seccion> Secciones { get; set; }

        public int CantidadMoviles { get; set; }
        public int CantidadPersonal { get; set; }
        public int CantidadFlotas { get; set; }
